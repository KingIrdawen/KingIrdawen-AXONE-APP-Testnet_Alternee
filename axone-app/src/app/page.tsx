  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="min-h-screen flex relative">
        {/* Dégradé vertical : Stellar Green au centre, couleur intermédiaire aux extrémités */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#008a8a] via-[#011f26] to-[#008a8a]"></div>
      ...
      {/* Section 2 - Features */}
      <section className="min-h-screen flex relative">
        {/* Dégradé vertical : Couleur intermédiaire au début, noir au centre, couleur intermédiaire à la fin */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#008a8a] via-black to-[#008a8a]"></div>
        <div className="flex-1 flex items-center justify-start relative z-10">
          <div className="px-36 md:px-48">
            <div className="max-w-2xl">
              <div className="text-left">
      ...
      <section className="min-h-screen flex relative">
        {/* Dégradé vertical : Couleur intermédiaire au début, Stellar Green au centre, couleur intermédiaire à la fin */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#008a8a] via-[#011f26] to-[#008a8a]"></div>
        <div className="flex-1 flex items-center justify-center relative z-10">
          <div className="w-full h-full">
            <video
